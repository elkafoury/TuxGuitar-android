...
import org.herac.tuxguitar.javax.sound.sampled.AudioFormat;
import org.herac.tuxguitar.javax.sound.sampled.AudioSystem;
import org.herac.tuxguitar.javax.sound.sampled.DataLine;
...
import org.herac.tuxguitar.javax.sound.sampled.SourceDataLine;
import org.herac.tuxguitar.javax.sound.sampled.TargetDataLine;
...
public class TGMixer extends TGAbstractLine implements Mixer {
	...
	public TGMixer() {
		...
		for (int channels = 1; channels <= 2; channels++) {
			formats.add(new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, AudioSystem.NOT_SPECIFIED, 8, channels, channels, AudioSystem.NOT_SPECIFIED, false));
			formats.add(new AudioFormat(AudioFormat.Encoding.PCM_UNSIGNED, AudioSystem.NOT_SPECIFIED, 8, channels, channels, AudioSystem.NOT_SPECIFIED, false));
				for (int bits = 16; bits < 32; bits += 8) {
					formats.add(new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, AudioSystem.NOT_SPECIFIED, bits, channels, channels * bits / 8, AudioSystem.NOT_SPECIFIED, false));
					formats.add(new AudioFormat(AudioFormat.Encoding.PCM_UNSIGNED, AudioSystem.NOT_SPECIFIED, bits, channels, channels * bits / 8, AudioSystem.NOT_SPECIFIED, false));
					formats.add(new AudioFormat(AudioFormat.Encoding.PCM_SIGNED, AudioSystem.NOT_SPECIFIED, bits, channels, channels * bits / 8, AudioSystem.NOT_SPECIFIED, true));
					formats.add(new AudioFormat(AudioFormat.Encoding.PCM_UNSIGNED, AudioSystem.NOT_SPECIFIED, bits, channels, channels * bits / 8, AudioSystem.NOT_SPECIFIED, true));
				}
