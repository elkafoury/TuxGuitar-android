...
import org.herac.tuxguitar.javax.sound.midi.MidiSystem;
import org.herac.tuxguitar.javax.sound.midi.Patch;
import org.herac.tuxguitar.javax.sound.midi.Soundbank;
import org.herac.tuxguitar.javax.sound.midi.Synthesizer;
...
public class MidiSynthesizerManager {
    ...
    public InputStream findResource(Patch patch) {
        ...
        AssetManager assets = TGActivityController.getInstance(context).getActivity().getAssets();
