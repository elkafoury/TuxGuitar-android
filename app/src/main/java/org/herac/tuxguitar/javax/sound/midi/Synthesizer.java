 ...
 * the <code>Synthesizer</code>'s {@link javax.sound.midi.MidiChannel} objects receives a
 * {@link javax.sound.midi.MidiChannel#noteOn(int, int) noteOn} message, either
 ...
 * {@link #isSoundbankSupported(javax.sound.midi.Soundbank) isSoundbankSupported} method of
 ...
 *
 * @see javax.sound.midi.MidiSystem#getSynthesizer
 * @see javax.sound.midi.Soundbank
 * @see javax.sound.midi.Instrument
...
public interface Synthesizer extends MidiDevice {
     ...
     * @see #getLoadedInstruments
     * @see #isSoundbankSupported(javax.sound.midi.Soundbank)
     * @see #loadInstrument
     */
     ...
     * @throws IllegalArgumentException thrown if the soundbank is not supported.
     * @see #isSoundbankSupported
     * @see javax.sound.midi.Instrument#getPatch
     * @see #loadAllInstruments
     * @see #loadInstrument
